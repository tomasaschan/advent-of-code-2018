...
spec = describe "Dec 8" $ do
  ...
  let d = NodeInfo { header   = Header { childCount = 0, metaCount = 1 }
                   , children = []
                   , meta     = [99]
                   }
  let c = NodeInfo { header   = Header { childCount = 1, metaCount = 1 }
                   , children = [d]
                   , meta     = [2]
                   }
  let b = NodeInfo { header   = Header { childCount = 0, metaCount = 3 }
                   , children = []
                   , meta     = [10, 11, 12]
                   }
  let a = NodeInfo { header   = Header { childCount = 2, metaCount = 3 }
                   , children = [b, c]
                   , meta     = [1, 1, 2]
                   }
